...
if(isset($_POST['ask'])){
    ...
    $sql = "insert into my_post(post_id,user_name) values('$p_id','$user_name')";
    $db->query($sql);
    ...
    for($i = 0; $i < count($temp); $i++){
        $sql = "insert into post_tag(tag_name,post_id) values('$temp[$i]','$p_id')";
        $db->query($sql);
    }
   ...
   <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        <div class="col-lg-8" style="    margin-left: 295px;width: 72%;border: 2px solid;border-radious:5px;padding:10px;">
            <form action="ask.php" enctype="multipart/form-data" method="post">
            <div style="
                        margin-top: 12px;
                        padding: 8px">
